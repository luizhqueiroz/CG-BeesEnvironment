...
void main() {
    ...
    // Color changing with the height of the grass
    gl_FragColor = vec4(vVertexPosition.y*0.02 + color.r*0.25, vVertexPosition.y*0.02 + color.g*0.25, vVertexPosition.y*0.02 + color.b*0.25, color[3]);
}
